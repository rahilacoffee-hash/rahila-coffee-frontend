      ...
      <div className="w-full max-w-[450px] bg-white p-8 md:p-12 rounded-[32px] shadow-sm border border-stone-100">
        ...
        {sent ? (
          <div className="text-center">
            ...
            <p className="text-green-700 font-bold text-[15px] mb-2">
              OTP Sent!
            </p>
            <p className="text-stone-400 text-[13px]">
              Check your inbox at{" "}
              <span className="font-bold text-amber-900">{email}</span>.<br />
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            {error && (
              <p className="text-red-500 text-[13px] text-center bg-red-50 px-3 py-2 rounded-xl">
                {error}
              </p>
            )}
            ...
            <div className="text-center pt-2">
              <Link
                to="/login"
                className="text-sm text-amber-900 font-black hover:underline"
              >
                ← Back to Login
              </Link>
            </div>
